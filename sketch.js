...
function setup(){
	...
	dground = new Ground(500,600,1000,20);
...
//function detectCollision(lstones,lmango){
	...
	//if(lstones.body.position.x-lmango.body.position.x<lmango.diameter + lstones.diameter
		//&& lmango.body.position.x - lstone.body.position.x< lmango.diameter + lstones.diameter
		//&& lstones.body.position.y - lmango.body.position.y< lmango.diameter + lstones.diameter
		//&& lmango.body.position.y - lstone.body.position.y< lmango.diameter + lstones.diameter) {
